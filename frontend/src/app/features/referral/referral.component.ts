    ...
    <div class="referral-container grid p-4 md:p-6 fadein animation-duration-500">
      ...
      <div class="col-12 mb-4">
        ...
        <p class="text-secondary mt-2 text-lg m-0">
          Invite friends to GST Buddy and both of you earn bonus credits!
        </p>
      </div>
...
export class ReferralComponent implements OnInit {
    ...
    shareEmail(): void {
        const link = this.referralLink();
        if (link) {
            const subject = encodeURIComponent('Try GST Buddy — we both get bonus credits!');
            const body = encodeURIComponent(`Hey,\n\nI've been using GST Buddy for Rule 37 compliance checks and it's great. Sign up with my referral link and we both get bonus credits:\n\n${link}\n\nCheers!`);
